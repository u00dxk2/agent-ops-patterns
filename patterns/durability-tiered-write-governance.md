...
Place every action an agent can take on a three-rung ladder, and put the governance where the durability is. The thinking upstream of this is Cliff Rosen's, at Orchestrator Studios - ["The Agent in the Middle"](https://orchestratorstudios.com/articles/the-agent-in-the-middle.html) separates the durable substrate from the UX layer frozen on top of it, and ["The Living Workspace"](https://orchestratorstudios.com/articles/living-workspace.html) works in primitives it tags as presentation, access, understanding, substrate and frame. The three-rung ladder below is not his tiering and shouldn't be read as his - it's our operational adaptation, plus the tests that make each rung enforceable rather than aspirational.
